...
@Component
public class BingSearchHotItemNormalizer implements HotItemNormalizer {

    private final ObjectMapper objectMapper;
    private final UrlCanonicalizer urlCanonicalizer;

    public BingSearchHotItemNormalizer(ObjectMapper objectMapper, UrlCanonicalizer urlCanonicalizer) {
    ...
    public Optional<NormalizedHotItem> normalize(RawItemEntity rawItem, SourceConfigEntity sourceConfig) {
        ...
        // 添加来源标签
        addTag(tags, seenTags, "bing-search");
        ...
        // 添加 market 标签
        String market = cleanText(payload.path("market").asText(""));
        addTag(tags, seenTags, market);
        ...
        // 构建作者
        String author = host.isBlank() ? "Bing Search" : host;
